...
public class MultiObjectiveDependencyHelperTest {
    ...
    @Before
    public void setUp() {
        this.helper = new SortedMultiObjectiveValuesHelper<String, String>(
                new LeximinOptimizer(SolverFactory.newDefault()));
        // helper = new
