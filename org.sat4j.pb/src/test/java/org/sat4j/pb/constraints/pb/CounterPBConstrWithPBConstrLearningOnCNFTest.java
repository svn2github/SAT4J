 ...
 */
public class CounterPBConstrWithPBConstrLearningOnCNFTest extends
        AbstractM2Test<IPBSolver> {

    /**
     * @param arg0
     */
    public CounterPBConstrWithPBConstrLearningOnCNFTest(String arg0) {
        super(arg0);
    }

    @Override
    protected IPBSolver createSolver() {
        mysolver = SolverFactory.newPBResAllPB();
        return mysolver;
    }
