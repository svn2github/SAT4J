 ...
 public class RTSI {
	...
	public static Vector<String> alreadySeenPckges; 
     ...
     public static Vector<String> find(String tosubclassname) {
    	 ...
    	 Vector<String> tmp;
         try {
//        	 ClassLoader.getSystemClassLoader().setPackageAssertionStatus("org.sat4j", true);
             ...
             for (int i=0;i<files.length;i++) {
                 ...
                 if (files[i].endsWith(".class")) {
                     ...
                     try {
                         ...
                         if (tosubclass.isAssignableFrom(o) && !o.isInterface() && !Modifier.isAbstract(o.getModifiers())) {
