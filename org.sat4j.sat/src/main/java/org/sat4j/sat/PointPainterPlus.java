...
public class PointPainterPlus extends APointPainter<PointPainterPlus> {
	...
	public void paintPoint(final int absoluteX, final int absoluteY, final int nextX,
		...
		g.drawLine(absoluteX-plusSize/2, absoluteY, absoluteX+plusSize/2, absoluteY);
		g.drawLine(absoluteX, absoluteY-plusSize/2, absoluteX, absoluteY+plusSize/2);
	}
	 ...
	 * 
	 * @param plusSize the size of the plus point in pixels
	 */
