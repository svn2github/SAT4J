...
public class PointPainterCross extends APointPainter<PointPainterPlus> {
	...
	public void paintPoint(final int absoluteX, final int absoluteY, final int nextX,
		...
		g.drawLine(absoluteX-crossSize/2, absoluteY-crossSize/2, absoluteX+crossSize/2, absoluteY+crossSize/2);
		g.drawLine(absoluteX-crossSize/2, absoluteY+crossSize/2, absoluteX+crossSize/2, absoluteY-crossSize/2);
	}
	 ...
	 * 
	 * @param crossSize the size of the cross point in pixels
	 */
