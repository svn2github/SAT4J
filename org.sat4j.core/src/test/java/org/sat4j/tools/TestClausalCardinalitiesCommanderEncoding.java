...
public class TestClausalCardinalitiesCommanderEncoding {
    ...
    public void testAtMostOne() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderAtMostOne");
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderAtMostOne models");
    ...
    public void testExactlyOne() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderExactlyOne");
            for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderExactlyOne models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtLeastOne() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderAtLeastOne");
            for (int i = 0; i < constr.size(); i++) {
                if (constr instanceof ConstrGroup)
                    System.out.println(((ConstrGroup) constr).getConstr(i));
                else
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderAtLeastOne models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtMost2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderAtMost2");
            if (constr instanceof ConstrGroup) {
                for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderAtMost2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtLeast2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderAtLeast2");
            if (constr instanceof ConstrGroup) {
                for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderAtLeast2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testExactly2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderExactly2");
            for (int i = 0; i < constr.size(); i++) {
                System.out.println(((ConstrGroup) constr).getConstr(i));
            }
        }
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderExactly2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtMostOneWith8Vars() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testCommanderAtMostOneWith8Vars");
            for (int i = 0; i < constr.size(); i++) {
                System.out.println(((ConstrGroup) constr).getConstr(i));
            }
        }
        ...
        if (MODE_DEBUG)
            System.out.println("testCommanderAtMostOneWith8Vars models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
