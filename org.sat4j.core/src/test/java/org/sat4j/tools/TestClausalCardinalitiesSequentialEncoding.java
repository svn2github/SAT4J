...
public class TestClausalCardinalitiesSequentialEncoding {
    ...
    public void testAtMostOne() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialAtMostOne");
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialAtMostOne models");
    ...
    public void testExactlyOne() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialExactlyOne");
            for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialExactlyOne models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtLeastOne() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialAtLeastOne");
            for (int i = 0; i < constr.size(); i++) {
                if (constr instanceof ConstrGroup)
                    System.out.println(((ConstrGroup) constr).getConstr(i));
                else
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialAtLeastOne models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtMost2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialAtMost2");
            if (constr instanceof ConstrGroup) {
                for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialAtMost2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtLeast2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialAtLeast2");
            if (constr instanceof ConstrGroup) {
                for (int i = 0; i < constr.size(); i++) {
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialAtLeast2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testExactly2() throws ContradictionException, TimeoutException {
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialExactly2");
            for (int i = 0; i < constr.size(); i++) {
                System.out.println(((ConstrGroup) constr).getConstr(i));
            }
        }
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialExactly2 models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
    ...
    public void testAtMostOneWith8Vars() throws ContradictionException,
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testSequentialAtMostOneWith8Vars");
            for (int i = 0; i < constr.size(); i++) {
                System.out.println(((ConstrGroup) constr).getConstr(i));
            }
        }
        ...
        if (MODE_DEBUG)
            System.out.println("testSequentialAtMostOneWith8Vars models");
        while (iterator.isSatisfiable()) {
            model = iterator.model();
            assertNotNull(model);
            if (MODE_DEBUG)
