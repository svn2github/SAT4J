...
public class TestClausalCardinalitiesBinomialEncoding {
    ...
    @Test
    public void testBinomialAtMostOne() throws ContradictionException,
            TimeoutException {
    ...
    @Test
    public void testBinomialExactlyOne() throws ContradictionException,
            TimeoutException {
        this.solver.newVar(5);
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testBinomialeExactlyOne");
            for (int i = 0; i < constr.size(); i++) {
    ...
    @Test
    public void testBinomialAtLeastOne() throws ContradictionException,
            TimeoutException {
        this.solver.newVar(5);
        ...
        if (MODE_DEBUG) {
            System.out.println();
            System.out.println("testBinomialeAtLeastOne");
            for (int i = 0; i < constr.size(); i++) {
                if (constr instanceof ConstrGroup)
                    System.out.println(((ConstrGroup) constr).getConstr(i));
                else
    ...
    @Test
    public void testBinomialAtMost2() throws ContradictionException,
            TimeoutException {
    ...
    @Test
    public void testBinomialAtLeast2() throws ContradictionException,
            TimeoutException {
    ...
    @Test
    public void testBinomialExactly2() throws ContradictionException,
            TimeoutException {
